-- Deploy sat-api-pg:20200728171657-fixmultilinks to pg

BEGIN;
DROP FUNCTION IF EXISTS convert_values;

CREATE OR REPLACE FUNCTION data.convert_values()
  RETURNS trigger AS
  $BODY$
  DECLARE
...
CREATE OR REPLACE FUNCTION data.convert_collection_links()
  RETURNS trigger AS
  $BODY$
  DECLARE
    newlinks data.linkobject[];
